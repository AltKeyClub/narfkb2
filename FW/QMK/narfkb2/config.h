...
#define ENCODERS_RESOLUTIONS { 4 } // Agrego para configurar encoder izquierdo
...
#define ENCODERS_RESOLUTIONS_RIGHT { 2 } //Agrego para configurar encoder derecho

#define RP2040_BOOTLOADER_DOUBLE_TAP_RESET
#define RP2040_BOOTLOADER_DOUBLE_TAP_RESET_TIMEOUT 500U
#define RP2040_BOOTLOADER_DOUBLE_TAP_RESET_LED GP16 //No se para que sea, pero estoy probando
